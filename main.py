...
def eyeCenterCoordinates(filePath):  # reads eye Center coordinates from Data File
    ...
    line2 = fp.readline()  # second line is the LEFT EYE
...
def predict_vid(vid):
    ...
    plt.title("Fixations in REye Progression")
    plt.xlabel("Milliseconds")
    plt.ylabel("Fixation")
    # plt.show()
    ...
    if ((averageFixationLengthMS >= 325) and (averageFixationLengthMS < 350)):
    ...
    if((averageFixationLengthMS > 350)):
...
# url_link = "https://fileuploadapp.blob.core.windows.net/tutorial-container/aman.mp4"
# urllib.request.urlretrieve(url_link, 'video_name.mp4') 
# predict_vid('video_name.mp4')
# end = time.time()
# print("Time taken for the function", (end-start))